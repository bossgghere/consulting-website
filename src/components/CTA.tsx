      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center md:text-left">
            <h2 className="text-4xl sm:text-5xl font-light text-white mb-3 sm:mb-4">How We Work with Clients</h2>
            <p className="text-lg sm:text-xl text-white/80 font-light">Explore how we partner with leaders in business and society.</p>
          </div>
          <motion.button
