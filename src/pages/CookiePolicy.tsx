  ...
  return (
    <LegalLayout title="Cookie" subtitle="Policy">
      <section className="space-y-6">
        <h2 className="text-3xl font-light text-bcg-dark tracking-tight">What are Cookies?</h2>
      ...
      <section className="space-y-6">
        <h2 className="text-3xl font-light text-bcg-dark tracking-tight">How We Use Cookies</h2>
        <p className="text-gray-600 font-light leading-relaxed">
      ...
      <section className="space-y-6">
        <h2 className="text-3xl font-light text-bcg-dark tracking-tight">Managing Your Preferences</h2>
        <p className="text-gray-600 font-light leading-relaxed">
