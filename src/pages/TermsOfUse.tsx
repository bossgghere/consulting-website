  ...
  return (
    <LegalLayout title="Terms" subtitle="of Use">
      <section className="space-y-6">
        <h2 className="text-3xl font-light text-text-primary tracking-tight">1. Acceptance of Terms</h2>
      ...
      <section className="space-y-6">
        <h2 className="text-3xl font-light text-text-primary tracking-tight">2. Use License</h2>
        <p className="text-text-secondary font-light leading-relaxed">
      ...
      <section className="space-y-6">
        <h2 className="text-3xl font-light text-text-primary tracking-tight">3. Disclaimer</h2>
        <p className="text-text-secondary font-light leading-relaxed">
      ...
      <section className="space-y-6">
        <h2 className="text-3xl font-light text-text-primary tracking-tight">4. Limitations</h2>
        <p className="text-text-secondary font-light leading-relaxed">
