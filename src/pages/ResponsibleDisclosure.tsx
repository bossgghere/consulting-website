  ...
  return (
    <LegalLayout title="Responsible" subtitle="Disclosure">
      <section className="space-y-6">
        <h2 className="text-3xl font-light text-text-primary tracking-tight">Vulnerability Reporting</h2>
      ...
      <section className="space-y-6">
        <h2 className="text-3xl font-light text-text-primary tracking-tight">Guidelines</h2>
        <p className="text-text-secondary font-light leading-relaxed">
      ...
      <section className="space-y-6">
        <h2 className="text-3xl font-light text-text-primary tracking-tight">Our Commitment</h2>
        <p className="text-text-secondary font-light leading-relaxed">
      ...
      <section className="space-y-6 text-sm text-gray-400 pt-8 border-t border-border-subtle">
        <h2 className="text-3xl font-light text-text-primary tracking-tight">How to Report</h2>
        <p className="text-gray-600 font-light leading-relaxed">
          Please send your findings to <a href="mailto:security@nexora.com" className="text-primary font-bold hover:underline">security@nexora.com</a>. We recommend using PGP encryption for sensitive details.
        </p>
      </section>
