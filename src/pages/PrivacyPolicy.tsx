  ...
  return (
    <LegalLayout title="Privacy" subtitle="Policy">
      <section className="space-y-6">
        <h2 className="text-3xl font-light text-text-primary tracking-tight">Introduction</h2>
      ...
      <section className="space-y-6">
        <h2 className="text-3xl font-light text-text-primary tracking-tight">Information We Collect</h2>
        <p className="text-text-secondary font-light leading-relaxed">
      ...
      <section className="space-y-6">
        <h2 className="text-3xl font-light text-text-primary tracking-tight">How We Use Your Data</h2>
        <p className="text-text-secondary font-light leading-relaxed">
      ...
      <section className="space-y-6">
        <h2 className="text-3xl font-light text-text-primary tracking-tight">Data Security</h2>
        <p className="text-text-secondary font-light leading-relaxed">
